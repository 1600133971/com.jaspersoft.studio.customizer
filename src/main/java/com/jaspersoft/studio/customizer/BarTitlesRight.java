...
public class BarTitlesRight extends JRAbstractChartCustomizer implements JRChartCustomizer {

	@Override
	public void customize(JFreeChart chart, JRChart jasperChart) {
		chart.getTitle().setHorizontalAlignment(HorizontalAlignment.RIGHT);
